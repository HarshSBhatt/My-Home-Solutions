...
export default function BookingConfirmation() {
    ...
    return (
        ...
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} marginTop={2} direction= "column">
            <Grid container spacing={2} columns={16} margin={10} style={{ display: "flex", alignItems: "center" }}>
                            ...
                            <Card sx={{ maxWidth: 550, mb : 5  }} key={property._id}>
                                <CardContent>
                                    ...
                                    <Typography sx={{ mb: 1.5 }} color="text.secondary">
                                       From : {moment(new Date(property.fromDate)).format("DD/MM/YYYY")}
                                    </Typography>
                                    <Typography sx={{ mb: 1.5 }} color="text.secondary">
