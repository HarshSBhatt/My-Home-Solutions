              ...
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    My Home provides the flexibility to let the user choose
                    between a house or a room. By selecting an entire house the
                    user will have the entire house for himself.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
            ...
            <Card sx={{ maxWidth: 345 }}>
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    My Home provides the flexibility to let the user choose
                    between a house or a room. By selecting a room the user will
                    have to be in the house on a sharing basis.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
